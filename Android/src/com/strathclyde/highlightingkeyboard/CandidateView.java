...
public class CandidateView extends View {
    ...
    private SoftKeyboardService mService;
     ...
     * @param listener
     */
    public void setService(SoftKeyboardService listener) {
        mService = listener;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //final int xspace = canvas.getWidth()-1;
        //int wordgap;
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (i<=3)
            {
            	wordWidth = (int) textWidth + X_GAP * 8;
            	hgap=X_GAP*4;
            }
            else
            {
            ...
            if (canvas != null) {
                ...
                //for the first 3 words, space them out to take the whole screen, the rest can go as they fit
                //canvas.drawText(suggestion, x + X_GAP, y, paint);
                canvas.drawText(suggestion, x + hgap, y, paint);
                paint.setColor(mColorOther); 
